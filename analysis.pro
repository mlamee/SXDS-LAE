...
for j=0,99 do begin
index_candidates2=where(vm gt c1[j]-0.05 and vm le c1[j]+0.05 and nbm-vm gt -3 and nbm-vm lt 3 and nbm-vm lt c2[j] and nbm - vm gt c3[j])
...
oplot,[vm[h]],[nbm[h]-vm[h]],psym=8, color=230
