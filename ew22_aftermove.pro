; I should this file with the new path information. 11/09/2015
...
name3='BVge0.4_err'
; I'm disabling all the spawn commands because I don't need to make
;new directories. 11/09/2015
...
;spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new2/BVge0.4_err'
close,/all
nb=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/CAT_527dual_f2.fits',1)
b=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/CAT_Bdual_f2.fits',1)
v=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/CAT_Vdual_f2.fits',1)
u=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/CAT_Unew2_dual_f2.fits',1)
;us=mrdfits('/Volumes/MacintoshHD2/supcam/quilt/CAT_Unew2.fits',1)
r=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/UKIDSS/subaru/ukidss_subR.fits',1)
readcol,'/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/sig.txt',skipline=2,filter,ap1,ap2,ap3,format='(a,f,f,f)'
readcol, '/Volumes/Mehdi2TB/manual-backup/MITCCDs/NB527.txt',lam527, p527,skipline=22
readcol,'/Volumes/Mehdi2TB/manual-backup/MITCCDs/B.txt',lamb,pb
readcol,'/Volumes/Mehdi2TB/manual-backup/MITCCDs/V.txt',lamv,pv
width_v=984.
zpv=35.378
zpb=35.231
zp527=33.817
...
n383=mrdfits('/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/CAT_383new.fits',1)
nm383=n383.mag_auto
f383=n383.flux_auto
xs3=n383.x_image-1
ys3=n383.y_image-1
;fxread,'/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/OBJECT.NB383.1.fits',ims383,hs383
fxread,'/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/OBJECT.NB383.1.exp',exp383,h383
...
x=nb.x_image-1
y=nb.y_image-1
fxread,'/Volumes/Mehdi2TB/manual-backup/April24_2015/quilt/OBJECT.527.1.fits',im527,h527
...
; Generating catalogs just based on the EW cut inside and also outside
; the LFC field of view 11/09/2015
idnobv=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108) ;and uf3 lt 3.*sigu and uf3 gt -100000 and  bm-vm ge 0.48 and ew-ewer ge 700./(27.75-nbm+2.5)+5)
idnobv2=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and ew ge 108); and exp383[x383,y383] ne 0 and uf3 lt 3.*sigu and uf3 gt -100000 and  bm-vm ge 0.48 and ew-ewer ge 700./(27.75-nbm+2.5)+5)

;for i=0, n_elements(idnobv2)-1 do print, ra[idnobv2[i]], dec[idnobv2[i]], format='(2(f10.5,2x))'
;checking with 383 image
id666=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 gt 3.*sigu and uf3 gt -100000 and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and  bm-vm ge 0.48); and ew-ewer ge 700./(27.75-nbm+2.5)+5)
...
device,filename=name2+'eww_2af.eps',/encap,/color ;IB527 vs Equivalent width
plotsym,2,1.5,/fill
cgplot,nbm[id5],ew[id5],psym=sym(0),charsize=1.5,xthick=3,ythick=3,thick=4,xr=[22,27],yr=[-250,1500],xstyle=1,ystyle=1,xtitle='IB527 [auto]',ytitle='Observed EW [Angstrom]',/nodata ;,title='Observed equivalent width'
cgplot,nbm[id5],ew[id5],psym=sym(0),color=get_colour_by_name('Dim_grey'),/overplot
cgplot,nbm[id66],ew[id66],psym=sym(1),color=get_colour_by_name('red'),/overplot
cgplot,nbm[id77],ew[id77],psym=sym(1),color=get_colour_by_name('cyan'),/overplot
...
cgplot,dum1,dum2,thick=4,color=get_colour_by_name('black'),/overplot 
cgplot,dum1,dum3,thick=4,color=get_colour_by_name('black'),/overplot 
...
device,/close
stop
device,filename=name2+'BVaf.eps',/encap,/color; B-V vs Equivalent width
plotsym,0,0.2,/fill
cgplot,bm[id5]-vm[id5],ew[id5],psym=sym(0),charsize=1.5,thick=4,xr=[-0.5,2.5],xthick=3,ythick=3,yr=[-200,1500],xstyle=1,ystyle=1,xtitle='B - V ',ytitle='Observed EW [Angstrom]',/nodata ;,title='Observed equivalent width 5sigma'
cgplot,bm[id5]-vm[id5],ew[id5],psym=sym(0),color=get_colour_by_name('Dim_grey'),/overplot
cgplot,bm[id66]-vm[id66],ew[id66],psym=sym(1),color=get_colour_by_name('red'),/overplot
cgplot,bm[id77]-vm[id77],ew[id77],psym=sym(1),color=get_colour_by_name('cyan'),/overplot
