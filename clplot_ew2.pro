...
id66=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and  bm-vm ge 0.48 and ew-ewer ge 700./(27.75-nbm+2.5)+5)
id662=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and  bm-vm ge 0.48 and ew-ewer2 ge 700./(27.75-nbm+2.5)+5)

id77=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew ge 700./(27.75-nbm+2.5)+5 and bm-vm ge 0.48 and ew-ewer lt 700./(27.75-nbm+2.5)+5)
id772=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew ge 700./(27.75-nbm+2.5)+5 and bm-vm ge 0.48 )
stop
;;;;;;;; Just a test plot
