...
!y.thick = 2
!z.thick = 2
name2='new/BVge0.4_err/'
name3='BVge0.4_err'
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new/All_err'
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt//new/All_noerr'
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err'  
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_noerr'
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_noerronly'
spawn, 'mkdir new/All_err'
spawn, 'mkdir new/All_noerr'
spawn, 'mkdir new/BVge0.4_err'
spawn, 'mkdir new/BVge0.4_noerr'
spawn, 'mkdir new/BVge0.4_noerronly'
spawn, 'mkdir plot2'
spawn,'mkdir /Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err'
close,/all
...
set_plot,'ps'
id5=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv   and exp383[x383,y383] ne 0 and bm gt 0  and nb.flags eq 0 and ew gt -200)

id6=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 ge 3.*sigu and bf3 ge 3.*sigb and exp383[x383,y383] ne 0 and bm gt 0  and nb.flags eq 0 and ew gt -200) ;Detection in both u and B
id7=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and bf3 ge 3.*sigb and exp383[x383,y383] ne 0 and bm gt 0  and nb.flags eq 0 and ew gt -200) ; Detection only B and not u
xx=indgen(30)/10.-2.
yy=-1.7*xx+1.13
id8=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 ge 3.*sigu and bf3 lt 3.*sigb and exp383[x383,y383] ne 0 and bm gt 0  and nb.flags eq 0 and ew gt -200) ; detection in u and not B
id9=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and bf3 lt 3.*sigb and exp383[x383,y383] ne 0 and bm gt 0  and nb.flags eq 0 and ew gt -200) ; Detection not in u nor B
id10=where(nbf3 ge 5.*signb and vf3 lt 3.*sigv   and exp383[x383,y383] ne 0 )
...
id66=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew-ewer ge 700./(27.75-nbm+2.5)+5 and uf3 lt 3.*sigu and  bm-vm ge 0.48)
id662=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew-ewer ge 700./(27.75-nbm+2.5)+5 and uf3 lt 3.*sigu); and  bm-vm ge 0.48)

id77=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew ge 700./(27.75-nbm+2.5)+5 and ew-ewer lt 700./(27.75-nbm+2.5)+5 and uf3 lt 3.*sigu and bm-vm ge 0.48)
id772=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew ge 700./(27.75-nbm+2.5)+5 and ew-ewer lt 700./(27.75-nbm+2.5)+5 and uf3 lt 3.*sigu); and bm-vm ge 0.48)
...
id88=where(nbf3 ge 5.*signb and vf3 ge 3.*sigv and uf3 lt 3.*sigu and nb.flags eq 0 and ew le ew_limit and exp383[x383,y383] ne 0 and ew ge 108 and ew ge 700./(27.75-nbm+2.5)+5 and bm-vm lt 0.48 )
x66=x[id66]
y66=y[id66]
...
plothist,vm66,bin=0.2,xtitle='V[auto]',ytitle='Number',xr=[23, 27.5],yr=[0,40],xstyle=1,ystyle=1,color=get_colour_by_name('red')
plothist,[vm66,vm77],bin=0.2,color=get_colour_by_name('blue'),linesyle=4,/overplot
device,/close
device,filename=name2+'bhist.eps',/encap,/color; Bhist
plothist,bm66,bin=0.2,xtitle='B[auto]',ytitle='Number',xr=[23.5, 28.9],yr=[0,26],xstyle=1,ystyle=1,color=get_colour_by_name('red')
plothist,[bm66,bm77],bin=0.2,color=get_colour_by_name('blue'),linesyle=4,/overplot
device,/close
device,filename=name2+'ewhist.eps',/encap,/color; ewhist
plothist,[ew[id66],ew[id77]],bin=100,xtitle='EW[Angstrom]',ytitle='Number',color=get_colour_by_name('blue')
plothist,ew66,bin=100,color=get_colour_by_name('red'),linesyle=4,/overplot
device,/close
device,filename=name2+'ibhist.eps',/encap,/color; ibhist
plothist,nbm66,bin=0.2,xtitle='IB527[auto]',ytitle='Number',xr=[23, 27],yr=[0,45],xstyle=1,ystyle=1,color=get_colour_by_name('red')
plothist,[nbm66,nbm77],bin=0.2,color=get_colour_by_name('blue'),linesyle=4,/overplot
device,/close
...
device,/close
device,filename=name2+'eww_u-exclude.eps',/encap,/color ;IB527 vs Equivalent width
plotsym,2,1.5,/fill
cgplot,nbm[id5],ew[id5],psym=sym(0),charsize=1.5,thick=4,xr=[18,28],yr=[-250,1000],xstyle=1,ystyle=1,xtitle='IB527 [auto]',ytitle='Observed EW [Angstrom]';,title='Observed equivalent width'
cgplot,nbm[id662],ew[id662],psym=sym(1),color=get_colour_by_name('red'),/overplot
cgplot,nbm[id772],ew[id772],psym=sym(1),color=get_colour_by_name('red'),/overplot 
...
plotsym,0,0.2,/fill
cgplot,bm[id5]-vm[id5],ew[id5],psym=sym(0),charsize=1.5,thick=4,xr=[-0.5,2.5],yr=[-200,2000],xstyle=1,ystyle=1,xtitle='B - V ',ytitle='Observed EW [Angstrom]' ;,title='Observed equivalent width 5sigma'
...
cgplot,[0.48,0.48],[-200, 2000],color=get_colour_by_name('green4'),/overplot
;cgplot,[mag527,mag527],[-2000,2000],color=get_colour_by_name('brown'),/overplot
...
hextract,im_r,hr,newim_r,newhr,x_r[i]-39,x_r[i]+39,y_r[i]-39,y_r[i]+39
...
for i=0, n_elements(xnt)-1 do begin
   hextract,im527,h527,newim527,newh527,xnt[i]-70,xnt[i]+70,ynt[i]-70,ynt[i]+70
   ...
   writefits,name,newim527,newh527
endfor
xdt=x66[in66]
ydt=y66[in66]
radt=ra66[in66]
...
for i=0, n_elements(xdt)-1 do begin
   hextract,im527,h527,newim527,newh527,xdt[i]-70,xdt[i]+70,ydt[i]-70,ydt[i]+70
...
for i=0, n_elements(xnt)-1 do begin
   hextract,imapt,hapt,newimapt,newhapt,xnt[i]-70,xnt[i]+70,ynt[i]-70,ynt[i]+70
   ...
   writefits,name,newimapt,newhapt
endfor
for i=0, n_elements(xdt)-1 do begin
   hextract,imapt,hapt,newimapt,newhapt,xdt[i]-70,xdt[i]+70,ydt[i]-70,ydt[i]+70
...
for i=0, n_elements(xdt)-1 do begin
   hextract,imv,hv,newim,newh,xdt[i]-70,xdt[i]+70,ydt[i]-70,ydt[i]+70
...
for i=0, n_elements(xnt)-1 do begin
   hextract,imb,hb,newim,newh,xnt[i]-70,xnt[i]+70,ynt[i]-70,ynt[i]+70
...
for i=0, n_elements(xdt)-1 do begin
   hextract,imb,hb,newim,newh,xdt[i]-70,xdt[i]+70,ydt[i]-70,ydt[i]+70
...
for i=0, n_elements(xnt)-1 do begin
   hextract,imu,hu,newim,newh,xnt[i]-70,xnt[i]+70,ynt[i]-70,ynt[i]+70
...
for i=0, n_elements(xdt)-1 do begin
   hextract,imu,hu,newim,newh,xdt[i]-70,xdt[i]+70,ydt[i]-70,ydt[i]+70
...
for i=0, n_elements(xnt3)-1 do begin
   hextract,im383,h383,newim,newh,xnt3[i]-29,xnt3[i]+29,ynt3[i]-29,ynt3[i]+29
...
for i=0, n_elements(xdt3)-1 do begin
   hextract,im383,h383,newim,newh,xdt3[i]-29,xdt3[i]+29,ydt3[i]-29,ydt3[i]+29
