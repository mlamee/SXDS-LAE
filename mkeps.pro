...
!y.thick = 2
!z.thick = 2
readcol,'/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/listU',nameU,format='a'
readcol,'/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/listB',nameB,format='a'
readcol,'/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/listV',nameV,format='a'
readcol,'/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/listNB',nameNB,format='a'
readcol,'/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/listLC',nameLC,format='a'
...
for k=0,n_elements(nameV)-1,8 do begin
   ...
   print,str
   device,filename='/Users/mehdi/Dropbox/Research/SupCam/eps/Figure2_'+str+'.eps',/encap,xsize=21,ysize=29
   for hh=0+k,7+k,1 do begin
      if hh gt n_elements(nameV)-1 then break
      h=hh
      if n_elements(nameV)- k lt 8 then h=hh+8-( n_elements(nameV)- k)
      dir='/Volumes/MacintoshHD2/supcam/quilt/new/BVge0.4_err/flag0/'
      print,nameu[hh]
